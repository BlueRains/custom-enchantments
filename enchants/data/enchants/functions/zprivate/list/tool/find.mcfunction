...
data modify storage list:compare A set from storage list:iteration Current.id


# tellraw @a [{"text":"Compared: "},{"storage":"list:compare","nbt":"A"},{"text":" and "},{"storage":"list:compare","nbt":"B"},{"text":" ("},{"storage":"list:iteration","nbt":"Current.Slot"},{"text":")"}]
